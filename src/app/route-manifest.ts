...
const ME: readonly RouteMeta[] = [
  ...
  { path: "/me/performance", title: "My review", hint: "Your appraisal, once your manager has shared it.", cap: "me.view", domain: "team", phase: "P2", icon: ClipboardList },
  ...
  { path: "/me/leave/apply", title: "Apply for leave", hint: "Say how many days, then split them across your balances.", cap: "me.view", domain: "leave", phase: "P1", icon: CalendarDays },
